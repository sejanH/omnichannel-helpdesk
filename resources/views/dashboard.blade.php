...
<head>
    ...
    <title>Omnichannel Support Helpdesk & Live Chat</title>
    <!-- Google Fonts -->
...
<body class="bg-slate-950 text-slate-100 flex h-screen overflow-hidden antialiased font-sans">
    ...
    <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between p-4 shrink-0">
        <div>
            ...
            <div class="flex items-center gap-3 px-2 py-3 mb-6 border-b border-slate-800">
                <div
                    class="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-indigo-500 to-cyan-400 flex items-center justify-center shadow-lg shadow-indigo-500/20">
                ...
                <div>
                    <h1 class="font-bold text-lg leading-tight tracking-tight text-white">OmniDesk</h1>
                    <span class="text-xs text-indigo-400 font-medium">Omnichannel Platform</span>
                </div>
            </div>

            <!-- Navigation Links -->
            <nav class="space-y-1">
                <button type="button" id="nav-tickets"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg bg-indigo-600/20 text-indigo-400 font-medium border border-indigo-500/30 transition text-left cursor-pointer">
                    ...
                    <span id="open-ticket-count"
                        class="ml-auto bg-indigo-500 text-white text-xs px-2 py-0.5 rounded-full font-bold">{{ $tickets->count() }}</span>
                </button>

                <button type="button" id="nav-widget-config"
                    class="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800/60 transition text-left cursor-pointer">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span
                        class="ml-auto text-[10px] bg-emerald-500/20 text-emerald-400 font-bold px-1.5 py-0.5 rounded border border-emerald-500/30">NEW</span>
                </button>

                <a href="#"
                    class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-400 hover:text-slate-200 hover:bg-slate-800/60 transition opacity-70 cursor-not-allowed">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="glass-panel p-3 rounded-xl flex items-center gap-3">
            <div class="relative">
                <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah" alt="Agent Avatar"
            ...
            <div class="overflow-hidden">
                <div class="font-semibold text-sm truncate text-slate-200">Sarah Connor</div>
                <div class="text-xs text-emerald-400 font-medium">Online (Agent)</div>
            </div>
        </div>
    </aside>
                    ...
                    <div
                        ...
                        <div id="prev-widget-box"
                            ...
                            <div class="p-2.5 border-t border-slate-800 bg-slate-900 flex items-center gap-2">
                                ...
                                <button type="button" id="prev-send-btn" class="p-1.5 text-white rounded-lg transition"
                                    style="background-color: #6366f1;">
